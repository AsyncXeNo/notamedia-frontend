      ...
      <div className="flex flex-col  items-center w-1/3 bg-nota-cyan h-full bg-nota-blue rounded-lg">
        ...
        <div className="flex justify-center items-center flex-col mt-12">
          <label htmlFor="upload" className="relative cursor-pointer">
            <div className="relative w-64 h-48 bg-gray-300 flex justify-center items-center rounded-lg overflow-hidden">
              {image ? (
                <>
                  <img
                    src={image}
        ...
        <div className="flex justify-center items-center h-12 w-28 bg-nota-lightblue rounded-full font-markazi-text text-xl font-bold mt-14 mb-10 ml-64">
